...
#ifndef __OMNETPP_CTOPOLOGY_MOD_H
#define __OMNETPP_CTOPOLOGY_MOD_H
...
/**
 * @brief Routing support. The cTopology_mod class was designed primarily to support
 * routing in telecommunication or multiprocessor networks.
 *
 * A cTopology_mod object stores an abstract representation of the network
 * in graph form:
 *  - each cTopology_mod node corresponds to a module (simple or compound), and
 *  - each cTopology_mod edge corresponds to a link or series of connecting links.
 *
 ...
 *
 * @ingroup Utilities
 * @see cTopology_mod::Node, cTopology_mod::Link, cTopology_mod::LinkIn, cTopology_mod::LinkOut
 */
class SIM_API cTopology_mod : public cOwnedObject
{
  public:
    class Link;
    class LinkIn;
    ...
    /**
     * @brief Supporting class for cTopology_mod, represents a node in the graph.
     */
    class SIM_API Node
    {
        friend class cTopology_mod;
      ...
      public:
         ...
         * weighted shortest path finder methods of cTopology_mod.
         */
         ...
         * with the shortest path finder methods of cTopology_mod.
         */
        bool isEnabled() const  {return enabled;}

        /**
         * Enable this node. This has significance with the shortest path
         * finder methods of cTopology_mod.
         */
    ...
    /**
     * @brief Supporting class for cTopology_mod, represents a link in the graph.
     */
    class SIM_API Link
    {
        friend class cTopology_mod;
    ...
    /**
     * @brief Supporting class for cTopology_mod.
     *
     * While navigating the graph stored in a cTopology_mod, Node's methods return
    ...
    /**
     * @brief Base class for selector objects used in extract...() methods of cTopology_mod.
     *
  ...
  public:
     ...
     * Constructor.
     */
    explicit cTopology_mod(const char *name=nullptr);

    /**
     * Copy constructor.
     */
    cTopology_mod(const cTopology_mod& topo);

    /**
     * Destructor.
     */
    virtual ~cTopology_mod();

    /**
     * Assignment operator. The name member is not copied; see cNamedObject's operator=() for more details.
     */
    cTopology_mod& operator=(const cTopology_mod& topo);
    //@}
     ...
     */
    virtual cTopology_mod *dup() const override  {return new cTopology_mod(*this);}
